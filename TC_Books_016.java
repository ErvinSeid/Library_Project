...
public class TC_Books_016 {
    public static void main(String[] args) {

        //Ability to view the books’ details
        // Pre-condition
...
// 3. Click on “Sign in” button
        ...
        books.click();
        // 2. Navigate to the book named “ernej”
        // 3. Click on “Detail”
        WebElement details=driver.findElement(By.xpath("//tbody/tr[425]/td[5]/a[2]"));
        details.click();
    }
}
